...
(function() {
  ...
  SwaggerModel = (function() {
    function SwaggerModel(modelName, obj) {
      var prop, propertyName, value, _i, _subTypeName;
    ...
    SwaggerModel.prototype.setReferencedModels = function(allModels) {
      var prop, type, _i, _len, _ref, _results, _reg, _refValueType, _refMapValueType, _subType;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (allModels[type] != null) {
          ...
          _refValueType = type;
          _refMapValueType = _reg.exec(_refValueType);
          if (_refMapValueType != null && _refMapValueType.length > 1) {
            _refValueType = _refMapValueType[1].split(',').pop();
          }
