...
(function() {
  var ApiKeyAuthorization, PasswordAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerMapElement, SwaggerSubType, SwaggerOperation, SwaggerRequest, SwaggerResource,
  ...
  SwaggerResource = (function() {
    ...
    SwaggerResource.prototype.addModels = function(models) {
      var model, modelName, swaggerModel, _i, _len, _ref, _results, _mapModel, _mapModelName, _modelWithMap, _modelsWithSubtypes;
      ...
      if (models != null) {
        ...
        for(modelName in this.models) {
          _modelWithMap = this.models[modelName];
  ...
  SwaggerModel = (function() {
    function SwaggerModel() {
     ...
     SwaggerModel.prototype.create = function (modelName, obj, parentModel) {
      ...
      for (propertyName in obj.properties) {
        ...
        _refMapValueType = _reg.exec(prop.dataType);
        if (_refMapValueType != null && _refMapValueType.length > 1) {
        	_mapValueModelName = _refMapValueType[1].split(',').pop();
        }
        if(_mapValueModelName !=null) {
           _mapModel = new SwaggerMapElement(propertyName+"KeyFor"+_mapValueModelName, propertyName, _mapValueModelName);
           this.mapModels.push(_mapModel); 
           _mapValueModelName = null;       
        }
    ...
    SwaggerModel.prototype.createMapModel = function (mapElement, objs){
       ...
       prop.refDataType = mapElement.mapValueModelName;       
       this.properties.push(prop);
       return this;
    };

    SwaggerModel.prototype.setReferencedModels = function(allModels) {
      var prop, type, _i, _j, _len, _mapModelIndex, _ref, _results, _refValueType, _mapModel, _subType;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        for(_j = 0, _hasLen = this.mapModels.length; _j < _hasLen; _j++) {
        	   _mapModel= this.mapModels[_j];
        	   if(prop.name === _mapModel.modelPropertyName) {
        	     _refValueType = _mapModel.name;
        	       break;
         		}        	   
          }
    ...
    SwaggerModel.prototype.getMockSignature = function(modelsToIgnore) {
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        prop = _ref1[_j];
        if(prop.refModel != null && prop.refModel.isMapKeyModel) {
        	prop = prop.refModel;
        }
  ...
  SwaggerModelProperty = (function() {
   ...
   SwaggerMapElement = (function() {
    function SwaggerMapElement(mapModelName, propertyName, mapValueModelName) {
    	  this.name = mapModelName;
    	  this.modelPropertyName = propertyName;
    	  this.mapValueModelName = mapValueModelName;
    	}
    return SwaggerMapElement;
    })();
...
SwaggerRequest.prototype.asCurl = function() {
  ...
  this.SwaggerMapElement = new SwaggerMapElement;
